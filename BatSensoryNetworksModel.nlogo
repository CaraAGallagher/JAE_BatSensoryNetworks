...
to update-monitors
  ...
  if length consecutive-networking-ts > 1 and max consecutive-networking-ts > 1 [ set-plot-x-range 1 max consecutive-networking-ts ]
...
@#$#@#$#@
<experiments>
  <experiment name="Try-it-yourself" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
